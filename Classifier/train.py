...
MODEL_CP_DIR = 'experiments/weights/binary_4conv_weights.best.hdf5'
MODEL_FINAL_DIR = 'experiments/weights/binary_4conv_weights.final.hdf5'
...
CONV_FINAL_DIR = 'experiments/weights/binary_4conv_weights.final.hdf5'
...
def train(MODEL, num_layers):
    ...
    x_test = load_text_dataset(os.path.join(TEXT_DATA_DIR,'testright/articles.txt'))
    y_test = load_text_dataset(os.path.join(TEXT_DATA_DIR,'testright/tags.txt'))
    ...
    #word_index  = pad_to_max_tokens(word_index , maxlen=MAX_SEQUENCE_LENGTH)
