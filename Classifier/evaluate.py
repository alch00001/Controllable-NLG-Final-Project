...
# MAX_NUM_WORDS = 20000
# EMBEDDING_DIM = 100
#MODEL_FINAL_DIR = 'experiments/weights/binary_3lstm_weights.final.hdf5'
...
if __name__ == '__main__':
    ...
    x_test = load_text_dataset(os.path.join(TEXT_DATA_DIR,'testleft/articles.txt'))
    y_test = load_text_dataset(os.path.join(TEXT_DATA_DIR,'testleft/tags.txt'))
    ...
    #y_test = pd.get_dummies(np.asarray(y_test))
    # print(y_test)
